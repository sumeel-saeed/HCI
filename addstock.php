...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $stmt = $conn->prepare("INSERT INTO `stock` (stockname, stockprice, stockquantity) VALUES (?, ?, ?)");
    $stmt->bind_param("sss", $stockname, $stockprice, $stockquantity);
    ...
    if ($stmt->execute()) {
        ...
        $output .= "<p><strong>Stock Name:</strong> $stockname</p>";
        $output .= "<p><strong>Stock Price:</strong> $stockprice</p>";
        $output .= "<p><strong>Stock Quantity:</strong> $stockquantity</p>";
        $output .= "</div>";
