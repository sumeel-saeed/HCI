<?php
    if ($_SERVER["REQUEST_METHOD"] === "POST") {
        ...
        $stmt = $conn->prepare("INSERT INTO `order` (ordername, orderprice, orderdate) VALUES (?, ?, ?)");
        $stmt->bind_param("sss", $ordername, $orderprice, $orderdate);
        ...
        if ($stmt->execute()) {
            ...
            $output .= "<p><strong>Order Date:</strong> $orderdate</p>";
            $output .= "</div>";
