...
<body>
    ...
    <table>
        <tr>
            <th width="150px">Stock ID<br><hr></th>
            <th width="250px">Stock Name<br><hr></th>
            <th width="150px">Stock Price<br><hr></th>
            <th width="150px">Stock Quantity<br><hr></th>
        </tr>
        <?php
        $sql = mysqli_query($link, "SELECT stock_id, stockname, stockprice, stockquantity FROM `stock`");
