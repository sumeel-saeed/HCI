...
<body>
    ...
    <form method="post" action="deletereport.php">
        ...
        <input type="text" name="totalsale">

        <label for="inventoryvalue">Inventory Value:</label>
        <input type="text" name="inventoryvalue">
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "DELETE FROM `report` WHERE reportname=? AND totalsale=? AND inventoryvalue=?";
        
        $stmt = mysqli_prepare($link, $sql);
        mysqli_stmt_bind_param($stmt, "sss", $reportname, $totalsale, $inventoryvalue);
